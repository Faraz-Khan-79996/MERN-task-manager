      ...
      <header className='flex justify-between sticky top-0 p-4 bg-white shadow-sm items-center'>
        <div className='flex'>
          <h2 className='cursor-pointer  font-medium'>
            <Link to="/"> Assignment Tracker </Link>
          </h2>
          <h3 className='ml-6 cursor-pointer hidden md:block italic font-medium'>
            <Link to="/leaderboard"> LeaderBoard </Link>
          </h3>
          <h3 className='ml-6 cursor-pointer italic hidden md:block font-medium'>
            <Link to="/"> Assignments </Link>
          </h3>
          <h3 className='ml-6 cursor-pointer italic hidden md:block font-medium'>
            <Link to="/tasks"> Your Todo </Link>
          </h3>
        </div>
        ...
        <div className={`absolute md:hidden right-0 top-0 bottom-0 transition ${(isNavbarOpen === true) ? 'translate-x-0' : 'translate-x-full'} bg-gray-100 shadow-md w-screen sm:w-9/12 h-screen`}>
          ...
          <ul className='flex flex-col gap-4  font-medium text-center'>
            ...
            <h3 className='ml-6 cursor-pointer block md:hidden italic font-medium'>
              <Link to="/leaderboard"> LeaderBoard </Link>
            </h3>
            <h3 className='ml-6 cursor-pointer italic block md:hidden font-medium'>
              <Link to="/"> Assignments </Link>
            </h3>
            <h3 className='ml-6 mb-10 cursor-pointer italic block md:hidden font-medium'>
              <Link to="/tasks"> Your Todo </Link>
            </h3>
            {authState.isLoggedIn ? (
              <>
